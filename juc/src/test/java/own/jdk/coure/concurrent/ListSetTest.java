package own.jdk.coure.concurrent;

import junit.framework.TestCase;
import own.jdk.course.concurrent.CoarseLists;
import own.jdk.course.concurrent.Entry;
import own.jdk.course.concurrent.ListSet;
import own.jdk.course.concurrent.SyncList;
...
public class ListSetTest extends TestCase {
    ...
    private void testCoarseGrainedLockingHelper(final SequenceGenerator addSeq,
        ...
        final TestResultsPair results = runKernel(() -> new CoarseLists.CoarseList(),
    ...
    public void testReadWriteLocksHelper(final SequenceGenerator addSeq,
                                         ...
                                         final double expectedContains, final double expectedRemove,
                                         final String datasetName) throws InterruptedException {
        final TestResultsPair results = runKernel(() -> new CoarseLists.RWCoarseList(),
