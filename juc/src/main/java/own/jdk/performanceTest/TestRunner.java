package own.jdk.performanceTest;

import own.jdk.performanceTest.model.Task;
import own.jdk.performanceTest.processor.AbstractTaskProcessor;
import own.jdk.performanceTest.producer.TaskProducer;
import own.jdk.performanceTest.result.TaskResultHandler;
import own.jdk.performanceTest.rmq.RMQSegmentTree;
...
/**
 *
 * **** copy from git ,cause can't not use ant *****
 *
...
public class TestRunner {
     ...
     */
    private static String PROCESSOR_PACKAGE = "own.jdk.performanceTest.processor.";
